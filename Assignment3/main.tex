...
Solve:
\begin{align}
    \max_{\{x\}} Z=\myvec{4 & 1}\vec{x}\label{eq:1}\\
    s.t\quad \myvec{1 & 1\\3 & 1} \leq \myvec{50\\90}\label{eq:2}\\
    \Vec{x}\geq 0 \label{eq:3}
\end{align}
	
\section{Solution}
Adding slack variables to the left side of \eqref{eq:2} and \eqref{eq:3},we get
\begin{align}
    Z-4x-y=0\\
    x+y+s_1=50\\
    3x+y+s_2=90
