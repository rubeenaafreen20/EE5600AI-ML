...
\begin{align}
    P=\frac{number of outcomes}{Sample space}
\end{align}

\section{Solution}
Let X \in \left\{ i \right\}_{i=1}^{i=6} and f_i be the corresponding frequency. Then,
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{singleout.JPG}
\captionof{figure}{Output when single digit is entered}\label{fig:1}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{multiout.JPG}
\captionof{figure}{Output when more than one digits are entered}\label{fig:2}
\end{figure}
\end{document}