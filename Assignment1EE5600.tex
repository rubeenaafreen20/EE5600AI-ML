...
\\
\begin{align}
    \bm AB=A-B=\myvec{-2\\-1}-\myvec{4\\0}=\myvec{-6\\-1}
\end{align}
\begin{align}
   \bm BC=B-C=\myvec{4\\0}-\myvec{3\\3}=\myvec{1\\-3}
\end{align}
\begin{align}
   \bm DC=D-C=D=\myvec{-3\\2}-\myvec{3\\3}=\myvec{-6\\-1}
\end{align}
and
\begin{align}
   \bm AD=A-D=A=\myvec{-2\\-1}-\myvec{-3\\2}=\myvec{1\\-3}
\end{align}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=9.5cm]{plotquad.png}
\end{figure}
Fig. 1: Plot of parallelogram ABCD
